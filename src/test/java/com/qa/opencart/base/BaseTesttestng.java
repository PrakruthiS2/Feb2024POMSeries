...
public class BaseTesttestng {
	...
	WebDriver driver;
	// it is default now so childclass of baseclass cant access loginpage methods
	// through obj
	// no selenium methods in test class
//	LoginPage loginpage;
	protected LoginPage loginpage; // bcoz defualt, private cant use used outside packageS, protected is exactly
									// like public but non subclass from different package cant access
	...
	@BeforeTest
	public void setUp(@Optional("chrome") String browserName, @Optional String browserversion ,@Optional String testname) // from parameters
																								// annotation browser is
	...
	{// creating obj of driver factory to use initPRop method
		...
		// this driver will be given to Loginpage and in login page constr this. driver
		// will give driver to private driver of that mrthod and driver can be used in
